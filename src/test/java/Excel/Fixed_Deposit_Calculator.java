...
public class Fixed_Deposit_Calculator {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i=1;i<=rows;i++)
		{
			...
			String princ=Excel_Utility.getCellData(file,"Sheet1",i,0);
			String rateofinterest=Excel_Utility.getCellData(file,"Sheet1",i,1);
			String per1=Excel_Utility.getCellData(file,"Sheet1",i,2);
			String per2=Excel_Utility.getCellData(file,"Sheet1",i,3);
			String fre=Excel_Utility.getCellData(file,"Sheet1",i,4);
			String exp_mvalue=Excel_Utility.getCellData(file,"Sheet1",i,5);
			...
			if(Double.parseDouble(exp_mvalue)==Double.parseDouble(act_mvalue))
			{
				...
				Excel_Utility.setCellData(file, "Sheet1",i,7,"Passed");
				Excel_Utility.fillGreenColor(file, "Sheet1",i,7);
			}
			else
			{
				System.out.println("Test Failed");
				Excel_Utility.setCellData(file, "Sheet1",i,7,"Failed");
				Excel_Utility.fillRedColor(file, "Sheet1",i,7);
			}
			Thread.sleep(3000);
